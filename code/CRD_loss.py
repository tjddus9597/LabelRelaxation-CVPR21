...
class CRDLoss(nn.Module):
    ...
    (a) using source as anchor, choose positive and negatives over the target side
    (b) using target as anchor, choose positive and negatives over the source side
    Args:
        opt.t_dim: the dimension of target's feature
        opt.s_dim: the dimension of source's feature
    ...
    def forward(self, f_t, f_s, idx, contrast_idx=None):
        """
        Args:
            f_t: the feature of target network, size [batch_size, t_dim]
            f_s: the feature of source network, size [batch_size, s_dim]
        ...
        out_t, out_s = self.contrast(f_t, f_s, idx, contrast_idx)
